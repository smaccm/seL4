...
>         _ -> liftM ArchInvokeIRQControl $ Arch.decodeIRQControl label args srcSlot extraCaps
...
> performIRQControl (ArchInvokeIRQControl i) = Arch.performIRQControl i
...
FIXME: this should be called perform, not invoke
